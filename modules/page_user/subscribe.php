...
$db->query("INSERT INTO `subscribes` SET `subscriber`=".$user['id'].", `to`=".$_GET['id']."");
$db->query("INSERT INTO `notifications` SET id_us`=".$_GET['id'].", `text`='us{".$user['id']."} подписался на Ваши новости!', `time`=".time().", `section`=2");
header('location:/us'.$_GET['id']);
?>